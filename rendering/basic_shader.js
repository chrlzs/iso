...
BasicShader.prototype.initShaderProgram = function (gl) {
    const vsSource = `
...
BasicShader.prototype.use = function (gl) {
    gl.useProgram(this.program);
};

BasicShader.prototype.setUniforms = function (gl, projectionMatrix, modelViewMatrix, normalMatrix, texture, normalTexture) {
    gl.uniformMatrix4fv(
