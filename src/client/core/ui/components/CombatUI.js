...
export class CombatUI {
    ...
    updateCombatantInfo() {
        ...
        this.playerInfo.innerHTML = `
            <div style="font-weight: bold; font-size: 18px;">${this.player.name}</div>
            <div>HP: ${this.player.health}/${this.player.maxHealth || 100}</div>
            <div class="health-bar" style="height: 10px; background-color: #333; margin-top: 5px; border-radius: 5px;">
                <div style="height: 100%; width: ${(this.player.health / (this.player.maxHealth || 100)) * 100}%; background-color: #0f0; border-radius: 5px;"></div>
            </div>
        ...
        this.enemyInfo.innerHTML = `
            <div style="font-weight: bold; font-size: 18px;">${this.enemy.name}</div>
            <div>HP: ${this.enemy.health}/${this.enemy.maxHealth || 100}</div>
            <div class="health-bar" style="height: 10px; background-color: #333; margin-top: 5px; border-radius: 5px;">
                <div style="height: 100%; width: ${(this.enemy.health / (this.enemy.maxHealth || 100)) * 100}%; background-color: #f00; border-radius: 5px;"></div>
            </div>
    ...
    handleActionClick(event) {
        ...
        if (!action || !this.isVisible || !this.game.combatSystem) {
            return;
        }
